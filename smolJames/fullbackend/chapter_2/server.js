...
// ENDPOINT - VERBS (method) && Routes (or paths)
...
app.post("/api/data", (req, res) => {
  ...
  // and their browser is wired up to send out a network request to the server to handle that action
...
app.delete("/api/data", (req, res) => {
  data.pop();
  console.log("We deleted an element off the end of the array");
  res.sendStatus(203);
});
